...
AddEventHandler("Farmcyc:recoleccion", function()
	...
	local camarones = xPlayer.getInventoryItem('camarones').count	
         ...
         if recoleccionsuerte < 50 then
         	...
         	TriggerClientEvent('esx:showNotification', source, '~r~No puedes llevar mas cangrejos')
else 
         ...
         elseif recoleccionsuerte > 51 then 
         	...
         	TriggerClientEvent('esx:showNotification', source, '~r~No puedes llevar mas camarones')
else 
